...
# $wav2adpcm -i sound/guffin.wav -f 10000 -c ADPCM4 -o sound/guffin.voc -l 7 -n 0.5
...
convertAnimation () {
    ...
    SpriteCompiler/build/sprite_compiler -f automatic -w 320 -i ${directory}/${filename}.tga -a ${directory}/${filename}.json -o ${directory}/${filename}.ani
}
